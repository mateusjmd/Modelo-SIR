...
modelos = ["Selecione um modelo", "Modelo SIR", "Modelo SIRD", "Modelo SIRD Duplo", "Dois Grupos Interagentes"]
...
if modelo_selecionado == "Selecione um modelo":
    st.warning("Por favor, selecione um modelo para iniciar a simulação.")
    
elif modelo_selecionado == "Modelo SIR":
    # Exibe a interface do modelo SIR simples
    st.header("Simulação do Modelo SIR")
    
    N = st.number_input('População Total', 100, 1000000, 1000)
    I0 = st.number_input("Infectados iniciais", 1, 1000, 1)
    R0 = 0
    S0 = N - I0 - R0
...
elif modelo_selecionado == "Modelo SIRD": # ---------------------------------------------------------------------------
...
elif modelo_selecionado == "Modelo SIRD Duplo": # ---------------------------------------------------------------------------
...
elif modelo_selecionado == "Dois Grupos Interagentes": # ---------------------------------------------------------------------------
    st.header("Modelo com Duas Populações Interagentes")
